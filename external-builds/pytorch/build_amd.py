...
for hip_platform_file in hip_platform_files:
    ...
    print("[DEBUG][build_amd.py] Project directory:", proj_dir)
    print("[DEBUG][build_amd.py] Output directory:", out_dir)
    print("[DEBUG][build_amd.py] Includes count:", len(includes))
    for inc in includes:
        print("    [INCLUDE]", inc)
    print("[DEBUG][build_amd.py] Ignores count:", len(ignores))
    for ign in ignores:
        print("    [IGNORE]", ign)
