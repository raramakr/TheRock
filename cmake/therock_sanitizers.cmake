function(therock_sanitizer_configure
  ...
  if(_sanitizer STREQUAL "ASAN")
    ...
    string(APPEND _stanza "string(APPEND CMAKE_SHARED_LINKER_FLAGS \" -fsanitize=address -shared-libsan\")\n")
    string(APPEND _stanza "string(APPEND CMAKE_EXE_LINKER_FLAGS \" -fsanitize=address -shared-libsan\")\n")
    string(APPEND _stanza "string(APPEND CMAKE_MODULE_LINKER_FLAGS \" -fsanitize=address -shared-libsan\")\n")
